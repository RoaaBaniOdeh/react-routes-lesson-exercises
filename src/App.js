    ...
    return (
      <Router>
        <div className="App">
          ...
          <Route path="/directory/:fentities" exact render={({ match }) => <Fentities match={match} fentities={this.state} />}/>
          <Route path="/directory/:fentities/:name" exact render={({ match }) => <Fentity match={match} fentities={this.state} />}/>
        </div>
      </Router>
    );
  }
